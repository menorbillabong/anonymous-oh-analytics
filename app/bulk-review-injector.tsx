...
export default function BulkReviewInjector(){
 ...
 useEffect(()=>{const capture=async(e:MouseEvent)=>{
  ...
  try{await prepareReview(urls.map(url=>({url})),mission)}finally{setLoading(false);btn.textContent=old}
