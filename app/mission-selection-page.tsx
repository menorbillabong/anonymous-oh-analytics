...
export default function MissionSelectionPage({uid,onClose,onSaved}:{uid:string;onClose:()=>void;onSaved:()=>Promise<void>}){
 ...
 <div className="mission-period-toolbar"><div className="mission-period-fields">
  ...
  <div className="mission-period-counter"><span>Publicações selecionadas no período</span><strong className="mission-period-count" role="status" aria-live="polite" aria-atomic="true">{period.per_user_limit===null?`${count} selecionadas · Sem limite`:`${count} de ${period.per_user_limit} selecionadas`}</strong></div>
 </div></div>
