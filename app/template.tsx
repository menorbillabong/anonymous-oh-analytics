...
import SimpleRefreshCounter from './simple-refresh-counter';
import './site-upgrades.css';
import './full-settings-v2.css';
import './color-customization.css';
export default function Template({children}:{children:React.ReactNode}){return <>{children}<BulkReviewInjector/><SiteUpgrades/><PostSortEnhancer/><SettingsPersistenceSync/><SimpleRefreshCounter/></>}
